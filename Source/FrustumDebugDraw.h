...
public:
    ...
    void addFrustum(const Frustum& f, const Vector3& color)
    {
        ...
        addLine(c[CI::NTL], c[CI::NTR], color); addLine(c[CI::NTR], c[CI::NBR], color);
        addLine(c[CI::NBR], c[CI::NBL], color); addLine(c[CI::NBL], c[CI::NTL], color);
        addLine(c[CI::FTL], c[CI::FTR], color); addLine(c[CI::FTR], c[CI::FBR], color);
