...
bool MaterialImporter::Save(const MaterialHeader& header, const std::string& baseColorPath, const std::string& normalPath, const std::string& aoPath, const std::string& emissivePath, const std::string& metalRoughPath, const std::string& file) {
	std::vector<char> payload;
	payload.reserve(baseColorPath.size() + normalPath.size() + aoPath.size() + emissivePath.size() + metalRoughPath.size());
