...
private:
	static bool Save(const MaterialHeader& header, const std::string& baseColorPath, const std::string& normalPath, const std::string& aoPath, const std::string& emissivePath, const std::string& metalRoughPath, const std::string& file);

	static std::string importTexture(int texIndex, const tinygltf::Model& model, const std::string& sceneName, const std::string& basePath);
};