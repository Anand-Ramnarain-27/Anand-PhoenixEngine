...
const D3D12_INPUT_ELEMENT_DESC StaticMesh::InputLayout[3] =
{
...
void StaticMesh::setData(const std::vector<Vertex>& vertices,
...
void StaticMesh::draw(ID3D12GraphicsCommandList* cmdList) const
{
    if (!m_vertexBuffer)
        return;
