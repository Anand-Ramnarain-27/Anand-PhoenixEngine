...
bool StaticModel::importFromGLTF(const char* fileName)
{
...
bool StaticModel::loadFromLibrary(const std::string& folder)
{
    m_meshes.clear();
...
void StaticModel::draw(ID3D12GraphicsCommandList* cmdList)
{
