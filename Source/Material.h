...
public:
    ...
    ID3D12Resource* getBaseColorResource()  const { return m_baseColorTex.Get(); }
    ID3D12Resource* getNormalMapResource()  const { return m_normalTex.Get(); }
    ID3D12Resource* getAOMapResource()      const { return m_aoTex.Get(); }
    ID3D12Resource* getEmissiveResource()   const { return m_emissiveTex.Get(); }
    ID3D12Resource* getMetalRoughResource() const { return m_metalRoughTex.Get(); }
